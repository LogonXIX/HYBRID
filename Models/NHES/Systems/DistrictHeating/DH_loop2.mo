...
model DH_loop2
  ...
  extends BaseClasses.Partial_SubSystem_A(
    redeclare replaceable DistrictHeating.CS.CS_Thigh CS,
    redeclare replaceable DistrictHeating.CS.ED_Dummy ED,
    redeclare Data.Data_Dummy data);

  NHES.Fluid.HeatExchangers.Generic_HXs.NTU_HX_SinglePhase HeatingPlant(
    NTU=data.NTU,
    K_tube=1,
    K_shell=1,

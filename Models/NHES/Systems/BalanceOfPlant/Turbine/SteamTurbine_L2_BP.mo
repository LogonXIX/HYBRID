...
equation
  ...
  connect(actuatorBus.FHV, FHV.opening) annotation (Line(
      points={{30,100},{30,34},{-110,34},{-110,4},{-100,4}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5), Text(
      string="%first",
  ...
  connect(actuatorBus.Feed_Pump_Speed, FWCP.in_m_flow) annotation (Line(
      points={{30,100},{30,-2},{2,-2},{2,-38},{-70,-38},{-70,-52.7}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5), Text(
      string="%first",
      ...
      extent={{-3,6},{-3,6}},
      horizontalAlignment=TextAlignment.Right));
  connect(FHV.port_b, nonLinear_Break.port_a)
    annotation (Line(points={{-92,-6},{-92,-17}}, color={0,127,255}));
  connect(nonLinear_Break.port_b, OFWH_2.port_a) annotation (Line(points={{-92,
          -37},{-92,-48},{-14,-48},{-14,-60},{-24,-60}}, color={0,127,255}));
  ...
  connect(FinalFeedwater_T.port, FWCP.port_b) annotation (Line(points={{-184,
          -82},{-184,-88},{-86,-88},{-86,-60},{-80,-60}}, color={0,127,255}));
  ...
  connect(sensorBus.Feedwater_Temp, FinalFeedwater_T.T) annotation (Line(
      ...
      extent={{-3,6},{-3,6}},
      horizontalAlignment=TextAlignment.Right));
  connect(multiPort.ports_b[3], FHV.port_a) annotation (Line(points={{-78,
          59.3333},{-84,59.3333},{-84,14},{-92,14}}, color={0,127,255}));

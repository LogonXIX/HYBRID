...
equation
  ...
  connect(actuatorBus.opening_TCV, TCV.opening) annotation (Line(
      points={{30.1,100.1},{-54,100.1},{-54,68},{-68,68}},
      color={111,216,99},
  ...
  connect(sensorBus.Steam_Temperature, Steam_T.T) annotation (Line(
      points={{-30,100},{-30,144},{-120,144},{-120,22},{-88,22}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5), Text(
      string="%first",
  ...
  connect(sensor_p.port, Steam_T.port)
    annotation (Line(points={{-94,32},{-82,32}}, color={0,127,255}));
  ...
  connect(TCV.port_b, sensor_p2.port) annotation (Line(points={{-58,60},{-50,60},
          {-50,78},{-76,78}}, color={0,127,255}));
  connect(HPT_bypass_valve.port_b, FWCP.port_a) annotation (Line(points={{-34,
          -14},{-34,-16},{-46,-16},{-46,-60}}, color={0,127,255}));
  connect(HPT.portLP, ECV.port_a)
    annotation (Line(points={{-26,60},{34,60}}, color={0,127,255}));
  connect(ECV.port_a, prt_b_steamdump) annotation (Line(points={{34,60},{34,-36},
          {60,-36},{60,-64},{44,-64},{44,-84},{60,-84},{60,-100}}, color={0,127,
          255}));
  connect(ECV.port_b, LPT.portHP)
    annotation (Line(points={{54,60},{74,60}}, color={0,127,255}));
  connect(sensor_p1.port, HPT.portLP)
    annotation (Line(points={{10,66},{10,60},{-26,60}}, color={0,127,255}));
  connect(lpTBV.port_b, condenser.port_a) annotation (Line(points={{-30,-78},{
          102,-78},{102,-43},{93,-43}}, color={0,127,255}));
  connect(TCV.port_b, HPT.portHP)
    annotation (Line(points={{-58,60},{-46,60}}, color={0,127,255}));
  connect(TCV.port_a, HPT_bypass_valve.port_a) annotation (Line(points={{-78,60},
          {-82,60},{-82,46},{-52,46},{-52,40},{-34,40},{-34,6}}, color={0,127,
          255}));
  connect(Steam_T.port, port_a_steam)
    annotation (Line(points={{-82,32},{-82,60},{-100,60}}, color={0,127,255}));
  connect(condenser.port_b, pump1.port_a) annotation (Line(points={{86,-58},{86,
          -68},{16,-68},{16,-60},{10,-60}}, color={0,127,255}));

...
equation
  ...
  connect(actuatorBus.Feed_Pump_Speed, pump2.inputSignal) annotation (Line(
      ...
      extent={{-3,6},{-3,6}},
      horizontalAlignment=TextAlignment.Right));
  connect(FHV.port_a, port_a_steam) annotation (Line(points={{-20,-122},{-76,
          -122},{-76,32},{-100,32},{-100,60}}, color={0,127,255}));
  connect(pump2.port_a, OFWH.port_b)

...
model SteamTurbine_L2_BP2_v_FWH
  ...
  MicroGrids.UA3HX uA3HX(redeclare package Medium =
        Modelica.Media.Water.StandardWater)
...
equation
  ...
  connect(actuatorBus.Feed_Pump_Speed, FWCP.in_m_flow) annotation (Line(
      points={{30,100},{30,-44},{-68,-44},{-68,-52.7}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5), Text(
      string="%first",
  ...
  connect(steam_T.port, header.port_b) annotation (Line(points={{-200,86},{-200,
          54},{-130,54},{-130,26},{-74,26},{-74,60}}, color={0,127,255}));
  ...
  connect(OFWH_2.port_b, uA3HX.port_a_fw)
    annotation (Line(points={{10,-60},{-28,-60}}, color={0,127,255}));
  connect(uA3HX.port_b_fw, FWCP.port_a)
    annotation (Line(points={{-48,-60},{-58,-60}}, color={0,127,255}));
  connect(header.port_b, uA3HX.port_a_hs) annotation (Line(points={{-74,60},{
          -74,32},{-60,32},{-60,-42},{-38,-42},{-38,-50}}, color={0,127,255}));
  connect(uA3HX.port_b_hs, FHV.port_a) annotation (Line(points={{-38,-70},{-38,
          -122},{-20,-122}}, color={0,127,255}));
  connect(FWCP.port_b, port_b_feed)
    annotation (Line(points={{-78,-60},{-100,-60}}, color={0,127,255}));
  connect(FinalFeedwater_T.port, port_b_feed) annotation (Line(points={{-184,
          -82},{-184,-88},{-100,-88},{-100,-60}}, color={0,127,255}));

...
model CS_L2_MEE3
  ...
  Modelica.Blocks.Sources.RealExpression MEE_Dis_mflow1(y=1)
    annotation (Placement(transformation(extent={{-86,-198},{-66,-178}})));
equation
  ...
  connect(actuatorBus.Feed_Pump_Speed, FeedPump_PID.y) annotation (Line(
      ...
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(actuatorBus.powerset, MEE_CVs.y) annotation (Line(
      points={{30,-100},{-39,-100},{-39,-130}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5), Text(
      string="%first",

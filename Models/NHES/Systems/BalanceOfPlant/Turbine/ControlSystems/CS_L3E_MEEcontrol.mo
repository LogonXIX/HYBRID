...
model CS_L3E_MEEcontrol

  extends NHES.Systems.BalanceOfPlant.Turbine.BaseClasses.Partial_ControlSystem;

  replaceable NHES.Systems.BalanceOfPlant.Turbine.Data.Data_L3E data
  ...
  Modelica.Blocks.Sources.RealExpression e_demand
    annotation (Placement(transformation(extent={{-60,20},{-40,40}})));
  Controls.LimOffsetPID Pin_PI_TCV1(
    controllerType=Modelica.Blocks.Types.SimpleController.PI,
    k=-1e-9,
    Ti=100,
    yMax=1,
  ...
  Modelica.Blocks.Sources.RealExpression w_demand
    annotation (Placement(transformation(extent={{-60,60},{-40,80}})));
  Modelica.Blocks.Sources.RealExpression w_gen
...
equation
  ...
  connect(sensorBus.Steam_Temperature, Tsteam_PI_FCV.u_m) annotation (Line(
      points={{-30,-100},{-30,-28},{2,-28},{2,-22}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(e_demand.y, Pin_PI_TCV.u_s)
  ...
  connect(sensorBus.W_net, Pin_PI_TCV.u_m) annotation (Line(
      points={{-30,-100},{-30,10},{0,10},{0,18}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(w_gen.y, Pin_PI_TCV1.u_m)
    annotation (Line(points={{-39,50},{0,50},{0,58}}, color={0,0,127}));
  connect(w_demand.y, Pin_PI_TCV1.u_s)
    annotation (Line(points={{-39,70},{-12,70}}, color={0,0,127}));
  connect(actuatorBus.ProcessCV, Pin_PI_TCV1.y) annotation (Line(

...
equation
  ...
  connect(sensorBus.W_turbines, W_PI_TCV.u_m) annotation (Line(
      ...
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(W_PI_TCV.y, firstOrder.u) annotation (Line(points={{11,32},{28,32},{
          28,30},{38,30}}, color={0,0,127}));
  connect(actuatorBus.opening_TCV, firstOrder.y) annotation (Line(
      points={{30.1,-99.9},{30.1,14},{61,14},{61,30}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5), Text(
      string="%first",

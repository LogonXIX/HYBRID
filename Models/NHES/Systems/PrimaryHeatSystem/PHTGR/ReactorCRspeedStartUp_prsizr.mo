...
model ReactorCRspeedStartUp_prsizr
...
equation
  ...
  connect(actuatorBus.CR_speed, controlRod.u) annotation (Line(
      ...
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(boundary2.ports[1], UP.port_b) annotation (Line(points={{-148,-68},{
          -152,-68},{-152,64},{-86,64},{-86,76},{-70,76}}, color={0,127,255}));
  annotation (
    ...
    Icon(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={
        Text(
          ...
          textString="%name")}));
end ReactorCRspeedStartUp_prsizr;

...
package DistrictHeating
  ...
  model DH_loop2
    ...
    extends BaseClasses.Partial_SubSystem_A(
      redeclare replaceable NHES.Systems.DistrictHeating.CS.CS_Thigh  CS,
      redeclare replaceable NHES.Systems.DistrictHeating.CS.ED_Dummy ED,
      redeclare Data.Data_Dummy data);
  ...
  equation
    ...
    connect(actuatorBus.Pump_speed, circ_pump.in_m_flow) annotation (Line(
        ...
        extent={{6,3},{6,3}},
        horizontalAlignment=TextAlignment.Left));
    connect(sensorBus.T_high, T_high_supply.T) annotation (Line(
        points={{-30,100},{-30,58},{-42,58},{-42,44},{-34,44}},
        color={239,82,82},
        pattern=LinePattern.Dash,
        thickness=0.5), Text(
        string="%first",

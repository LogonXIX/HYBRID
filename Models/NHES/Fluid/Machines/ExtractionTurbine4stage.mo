...
model ExtractionTurbine4stage
  ...
  parameter Modelica.Units.SI.MassFlowRate m_ext4=2 "Nominal Turbine First Extraction Flow Rate" annotation (Dialog(group="Extraction Points"));
     ...
     parameter Modelica.Units.SI.SpecificEnthalpy h_out=2e6;
...
equation
  ...
  connect(ST1.shaft_b,ST2. shaft_a) annotation (Line(points={{-74,0},{-58,0},{-58,
          -16},{-38,-16},{-38,0}},
                            color={0,0,0}));
  connect(pressureCV_v2_3.port_b, ST3.portHP)
    annotation (Line(points={{14,6},{18,6}}, color={0,127,255}));
  connect(ST3.portLP,MS3.port_a)
    annotation (Line(points={{38,6},{38,30},{46,30}},
                                             color={0,127,255}));
  connect(MS3.port_Liquid,port_b_extraction3)  annotation (Line(points={{48,26},
          {48,-86},{10,-86},{10,-100}}, color={0,127,255}));
  connect(MS3.port_b, pressureCV_v2_1.port_a) annotation (Line(points={{58,30},
          {66,30},{66,16},{54,16},{54,6},{58,6}}, color={0,127,255}));
  connect(pressureCV_v2_1.port_b, ST4.portHP)
  ...
  connect(pressureCV_v2_3.port_b, ST3.portHP)
    annotation (Line(points={{14,6},{18,6}}, color={0,127,255}));
  connect(ST4.portLP,port_b)  annotation (Line(points={{94,6},{94,46},{86,46},{86,
          60},{100,60}}, color={0,127,255}));
  connect(ST3.shaft_a, ST2.shaft_b) annotation (Line(points={{18,0},{18,-14},{-12,
          -14},{-12,0},{-18,0}}, color={0,0,0}));
  connect(ST2.portLP, pressureCV_v2_3.port_a)
    annotation (Line(points={{-18,6},{2,6}}, color={0,127,255}));
  connect(pressureCV_v2_3.port_a, port_b_extraction2) annotation (Line(points={
          {2,6},{-2,6},{-2,-86},{-30,-86},{-30,-100}}, color={0,127,255}));
  connect(port_b_extraction1, pressureCV_v2_2.port_a)
    annotation (Line(points={{-68,-100},{-68,6},{-54,6}}, color={0,127,255}));
  connect(pressureCV_v2_2.port_a, ST1.portLP)
    annotation (Line(points={{-54,6},{-74,6}}, color={0,127,255}));
  connect(pressureCV_v2_1.port_a, port_b_extraction4) annotation (Line(points={
          {58,6},{54,6},{54,-50},{82,-50},{82,-100},{50,-100}}, color={0,127,
          255}));

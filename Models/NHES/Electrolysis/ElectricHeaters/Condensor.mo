...
package Condensor
    ...
    import Modelica.Fluid.Types.Dynamics;
      ...
      // Initialization
        ...
        parameter Modelica.Units.SI.Temperature T_st=300 "init temp"
          annotation (Dialog(tab="Initialization"));
        parameter Modelica.Units.SI.Volume V(min=0)=1;
  ...
  equation
    //Energy Balance
    der(E)=m_in*h_in +m_l*h_l +m_v*h_v+Qhx;
    //Mass Balance
    //der(M)=m_in+m_l+m_v;
  ...
  equation
    ...
    annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
          coordinateSystem(preserveAspectRatio=false)));
  end SteamHydrogen_Volume2;

  model SteamHydrogen_Volumess
    import Modelica.Fluid.Types.Dynamics;
  ...
  equation
    //Energy Balance
    0=m_in*h_in +m_l*h_l +m_v*h_v+Qhx;
    //Mass Balance
    0=m_in+m_l+m_v;
    //Hydrogen Balance
    0=m_in*C_in+m_v*C_v;
